...
const grabAllAdjancentCells = (cells: Cell[][], rowParam: number, colParam: number)
    : {
...
export const generateCells = (): Cell[][] => {
    ...
    for (let rowIndex = 0; rowIndex < MAX_ROWS; rowIndex++) {
        for (let colIndex = 0; colIndex < MAX_COLS; colIndex++) {
            ...
            let numberOfBombs = 0;
            const { topLeftCell,topCell,topRightCell,leftCell,rightCell,bottomLeftCell,bottomCell,bottomRightCell,} 
            = grabAllAdjancentCells(cells, rowIndex, colIndex);
...
export const openMultipleCells =
    (cells: Cell[][], rowParam: number, colParam: number): Cell[][] => {
        ...
        const { topLeftCell,topCell,topRightCell,leftCell,rightCell,bottomLeftCell,bottomCell,bottomRightCell,} 
            = grabAllAdjancentCells(cells, rowParam, colParam);
